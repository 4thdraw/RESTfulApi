...
const mysql = require('mysql'); //dB연결하고 sql쿼리돌려서 원하는 DB빼오기위해 필요
const bodyParser = require('body-parser'); //req.body 파싱하려고
const router = express.Router(); //기본...
const dbconfig = require('./dbconfig'); 
//db정보 외부로 빼주기 깃허브에 올리지않도록 처리하기
...
// 다양한 플랫폼에서 쓸 수 있는 xml파일
var format = { language : 'sql', indent : '  '} 
// 노드가 쓸때 xml에 담아둔 정보가 sql언어이며, 띄어쓰기하기



router.use(bodyParser.json()); //req.body데이터 json화
